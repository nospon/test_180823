...
<div id="container">
	<!-- <!-- <img src="/data/201012/IJ12920904231853/logo.gif" alt="jQuery Air" id="logo" /> --> 
<!-- 	<span id="info">
...
<%-- <form >
<table id="choice_seat_list" style="display:none">
	<c:forEach items="${list }" var="seatVO">
		<c:if test="${seatVO.air_name}">
		<tr>
			<td>${seatVO.seat_num }</td>
			<td>${seatVO.seat_YN }</td>
			<td>${seatVO.air_name }</td>
		</tr>
		</c:if>
		</c:forEach>
